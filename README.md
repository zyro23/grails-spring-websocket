...
*The plugin is targeting Grails 2.4.0.RC1+. Lower versions will not work because they lack the mandatory Spring version 4.0+.*  
...
To install the plugin into a Grails application add the following line to your `BuildConfig.groovy` plugins section:
	...
	compile ":spring-websocket:1.0.0.RC1"
