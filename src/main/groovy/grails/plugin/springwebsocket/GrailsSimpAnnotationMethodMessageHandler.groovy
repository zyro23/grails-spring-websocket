...
/**
* Implementation of a Method Message Hanlder for Spring Websockets. It does not extend SimpMethodMessageHandler because due to an oversight on Spring's part
*. the AbstractMethodMessageHandler was not easily extensible where a critical method had to be replaced (afterPropertiesSet)
*/
@CompileStatic
class GrailsSimpAnnotationMethodMessageHandler extends AbstractMethodMessageHandler<SimpMessageMappingInfo>
	 ...
	 */
	public GrailsSimpAnnotationMethodMessageHandler(SubscribableChannel clientInboundChannel,
	...
	public void setMessageConverter(MessageConverter converter) {
		...
		if (converter != null) {
			((SimpMessagingTemplate) this.clientMessagingTemplate).setMessageConverter(converter);
		}
	}
	...
	protected boolean isHandler(Class<?> beanType) {
		return true// GrailsWebsocketClass.isAssignableFrom(beanType)
	}
